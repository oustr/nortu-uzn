...
语块 | 大致是什么 | <例子>和所处的语境
| - | - | -
名块（n.） | 发挥着像名词一样的作用 | 一只圆滚滚的<猫>；一只<圆滚滚的猫>
动块（v.） | 发挥着像动词一样的作用 | 大白天里舒服地<睡觉>；大白天里<舒服地睡觉>
形容块（o.） | 发挥着像形容词一样的作用 | 阳光般<闪耀的>日子；<阳光般闪耀的>日子
副块（u.） | 通常可以修饰动块、形容块 | <十分轻松地>完成任务；十分<轻松地>完成任务
介块（z.） | 可以改变整个语块的性质 | 我<的>床（“我”是名块，“我的”是形容块）；走<到>海边（“海边”是名块，“到海边”是副块）
连块（x.） | 把相同性质的语块合起来 | 氢<和>氧组成水（“氢”、“氧”都是名块，“氢和氧”也是名块）
其他块（c.） | 不属于上面六种的 | <啊啊啊啊啊>我的天<呐>家人们谁懂<啊啊啊啊>！！
